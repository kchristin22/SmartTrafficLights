...
#define MY_ADDRESS 69 // define my unique address
#define TRAFFIC 49 // address of main sensor
#define FINE 39 // address of busted sensor
#define LIGHT 99 // address of other traffic light
